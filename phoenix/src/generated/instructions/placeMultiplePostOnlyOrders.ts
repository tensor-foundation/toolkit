...
export const PLACE_MULTIPLE_POST_ONLY_ORDERS_DISCRIMINATOR = 16;

export function getPlaceMultiplePostOnlyOrdersDiscriminatorBytes() {
  return getU8Encoder().encode(PLACE_MULTIPLE_POST_ONLY_ORDERS_DISCRIMINATOR);
}
...
export function getPlaceMultiplePostOnlyOrdersInstructionDataEncoder(): Encoder<PlaceMultiplePostOnlyOrdersInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: PLACE_MULTIPLE_POST_ONLY_ORDERS_DISCRIMINATOR,
    })
  );
}
