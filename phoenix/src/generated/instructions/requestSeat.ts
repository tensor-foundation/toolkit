...
export const REQUEST_SEAT_DISCRIMINATOR = 14;

export function getRequestSeatDiscriminatorBytes() {
  return getU8Encoder().encode(REQUEST_SEAT_DISCRIMINATOR);
}
...
export function getRequestSeatInstructionDataEncoder(): Encoder<RequestSeatInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: REQUEST_SEAT_DISCRIMINATOR })
  );
}
