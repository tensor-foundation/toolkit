...
export const DEPOSIT_FUNDS_DISCRIMINATOR = 13;

export function getDepositFundsDiscriminatorBytes() {
  return getU8Encoder().encode(DEPOSIT_FUNDS_DISCRIMINATOR);
}
...
export type DepositFundsInstructionData = {
  ...
  quoteLotsToDeposit: bigint;
  baseLotsToDeposit: bigint;
};

export type DepositFundsInstructionDataArgs = {
  quoteLotsToDeposit: number | bigint;
  baseLotsToDeposit: number | bigint;
};

export function getDepositFundsInstructionDataEncoder(): Encoder<DepositFundsInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['quoteLotsToDeposit', getU64Encoder()],
      ['baseLotsToDeposit', getU64Encoder()],
    ]),
    (value) => ({ ...value, discriminator: DEPOSIT_FUNDS_DISCRIMINATOR })
  );
}

export function getDepositFundsInstructionDataDecoder(): Decoder<DepositFundsInstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['quoteLotsToDeposit', getU64Decoder()],
    ['baseLotsToDeposit', getU64Decoder()],
  ]);
}

export function getDepositFundsInstructionDataCodec(): Codec<
...
> = {
  ...
  quoteLotsToDeposit: DepositFundsInstructionDataArgs['quoteLotsToDeposit'];
  baseLotsToDeposit: DepositFundsInstructionDataArgs['baseLotsToDeposit'];
};
