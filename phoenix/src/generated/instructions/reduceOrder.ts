...
export const REDUCE_ORDER_DISCRIMINATOR = 4;

export function getReduceOrderDiscriminatorBytes() {
  return getU8Encoder().encode(REDUCE_ORDER_DISCRIMINATOR);
}
...
export function getReduceOrderInstructionDataEncoder(): Encoder<ReduceOrderInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: REDUCE_ORDER_DISCRIMINATOR })
  );
}
