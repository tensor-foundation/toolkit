...
export const CANCEL_MULTIPLE_ORDERS_BY_ID_WITH_FREE_FUNDS_DISCRIMINATOR = 11;

export function getCancelMultipleOrdersByIdWithFreeFundsDiscriminatorBytes() {
  return getU8Encoder().encode(
    CANCEL_MULTIPLE_ORDERS_BY_ID_WITH_FREE_FUNDS_DISCRIMINATOR
  );
}
...
export function getCancelMultipleOrdersByIdWithFreeFundsInstructionDataEncoder(): Encoder<CancelMultipleOrdersByIdWithFreeFundsInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: CANCEL_MULTIPLE_ORDERS_BY_ID_WITH_FREE_FUNDS_DISCRIMINATOR,
    })
  );
}
