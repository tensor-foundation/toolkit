...
import {
  ...
  type SeatApprovalStatus,
  type SeatApprovalStatusArgs,
} from '../types';

export const CHANGE_SEAT_STATUS_DISCRIMINATOR = 104;

export function getChangeSeatStatusDiscriminatorBytes() {
  return getU8Encoder().encode(CHANGE_SEAT_STATUS_DISCRIMINATOR);
}
...
export function getChangeSeatStatusInstructionDataEncoder(): Encoder<ChangeSeatStatusInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: CHANGE_SEAT_STATUS_DISCRIMINATOR })
  );
}
