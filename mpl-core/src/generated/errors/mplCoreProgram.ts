...
if (process.env.NODE_ENV !== 'production') {
  mplCoreProgramErrorMessages = {
    ...
    [MPL_CORE_PROGRAM_ERROR__EXTERNAL_PLUGIN_ADAPTER_ALREADY_EXISTS]: `External PluginExternalPluginAdapter already exists`,
    [MPL_CORE_PROGRAM_ERROR__EXTERNAL_PLUGIN_ADAPTER_NOT_FOUND]: `External PluginExternalPluginAdapter not found`,
