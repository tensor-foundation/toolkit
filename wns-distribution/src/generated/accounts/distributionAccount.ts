...
export const DISTRIBUTION_ACCOUNT_DISCRIMINATOR = new Uint8Array([
  98, 90, 112, 65, 49, 161, 198, 154,
]);

export function getDistributionAccountDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DISTRIBUTION_ACCOUNT_DISCRIMINATOR
  );
}
...
export function getDistributionAccountEncoder(): Encoder<DistributionAccountArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: DISTRIBUTION_ACCOUNT_DISCRIMINATOR })
  );
}
