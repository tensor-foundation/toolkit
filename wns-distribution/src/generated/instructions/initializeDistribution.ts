...
export const INITIALIZE_DISTRIBUTION_DISCRIMINATOR = new Uint8Array([
  146, 158, 129, 53, 22, 89, 86, 207,
]);

export function getInitializeDistributionDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    INITIALIZE_DISTRIBUTION_DISCRIMINATOR
  );
}
...
export function getInitializeDistributionInstructionDataEncoder(): Encoder<InitializeDistributionInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: INITIALIZE_DISTRIBUTION_DISCRIMINATOR,
    })
  );
}
