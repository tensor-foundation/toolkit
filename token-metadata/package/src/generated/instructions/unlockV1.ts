...
export type UnlockV1Instruction<
...
export type UnlockV1InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountTokenOwner extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
export function getUnlockV1InstructionDataEncoder(): Encoder<UnlockV1InstructionDataArgs> {
  return mapEncoder(
    getStructEncoder([
      ...
      ['unlockV1Discriminator', getU8Encoder()],
...
export function getUnlockV1InstructionDataDecoder(): Decoder<UnlockV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['unlockV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getUnlockV1InstructionDataCodec(): Codec<
  UnlockV1InstructionDataArgs,
  UnlockV1InstructionData
> {
  return combineCodec(
    getUnlockV1InstructionDataEncoder(),
    getUnlockV1InstructionDataDecoder()
  );
}

export type UnlockV1InstructionExtraArgs = { tokenStandard: TokenStandardArgs };

export type UnlockV1AsyncInput<
  TAccountAuthority extends string,
  TAccountTokenOwner extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export type UnlockV1AsyncInputWithSigners<
  TAccountAuthority extends string,
  TAccountTokenOwner extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export async function getUnlockV1InstructionAsync<
  TAccountAuthority extends string,
  TAccountTokenOwner extends string,
  TAccountToken extends string,
  TAccountMint extends string,
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
>(
  input: UnlockV1AsyncInputWithSigners<
    TAccountAuthority,
    TAccountTokenOwner,
    TAccountToken,
    TAccountMint,
  ...
  UnlockV1InstructionWithSigners<
    TProgram,
    TAccountAuthority,
    TAccountTokenOwner,
    TAccountToken,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getUnlockV1InstructionRaw<
      TProgram,
      TAccountAuthority,
      TAccountTokenOwner,
      TAccountToken,
  ...
  const instruction = getUnlockV1InstructionRaw(
    accountMetas as Record<keyof AccountMetas, IAccountMeta>,
    args as UnlockV1InstructionDataArgs,
    programAddress
  );
...
export type UnlockV1InputWithSigners<
  TAccountAuthority extends string,
  TAccountTokenOwner extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export function getUnlockV1Instruction<
  TAccountAuthority extends string,
  TAccountTokenOwner extends string,
  TAccountToken extends string,
  TAccountMint extends string,
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
>(
  input: UnlockV1InputWithSigners<
    TAccountAuthority,
    TAccountTokenOwner,
    TAccountToken,
    TAccountMint,
...
export function getUnlockV1InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountTokenOwner extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: UnlockV1InstructionDataArgs,
  ...
  return {
    ...
    data: getUnlockV1InstructionDataEncoder().encode(args),
    programAddress,
  } as UnlockV1Instruction<
    TProgram,
    TAccountAuthority,
    TAccountTokenOwner,
    TAccountToken,
...
export type ParsedUnlockV1Instruction<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
...
> = {
  ...
  data: UnlockV1InstructionData;
};

export function parseUnlockV1Instruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedUnlockV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getUnlockV1InstructionDataDecoder().decode(instruction.data),
  };
}
