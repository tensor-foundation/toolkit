...
export type UnverifyCreatorV1InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
export function getUnverifyCreatorV1InstructionDataEncoder(): Encoder<UnverifyCreatorV1InstructionDataArgs> {
  return mapEncoder(
    getStructEncoder([
...
export function getUnverifyCreatorV1InstructionDataDecoder(): Decoder<UnverifyCreatorV1InstructionData> {
...
export function getUnverifyCreatorV1InstructionDataCodec(): Codec<
...
export type UnverifyCreatorV1InputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountMetadata extends string,
  TAccountCollectionMint extends string,
...
export function getUnverifyCreatorV1Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
>(
  input: UnverifyCreatorV1InputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountMetadata,
    TAccountCollectionMint,
    ...
    TAccountSysvarInstructions
  >
): UnverifyCreatorV1InstructionWithSigners<
  TProgram,
  TAccountAuthority,
  TAccountDelegateRecord,
  TAccountMetadata,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getUnverifyCreatorV1InstructionRaw<
      TProgram,
      TAccountAuthority,
      TAccountDelegateRecord,
      TAccountMetadata,
  ...
  const instruction = getUnverifyCreatorV1InstructionRaw(
...
export function getUnverifyCreatorV1InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
