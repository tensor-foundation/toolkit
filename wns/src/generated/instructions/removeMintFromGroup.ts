...
export type RemoveMintFromGroupAsyncInput<
...
export async function getRemoveMintFromGroupInstructionAsync<
  TAccountPayer extends string,
  TAccountAuthority extends string,
  TAccountGroup extends string,
  TAccountMember extends string,
  ...
  TAccountTokenProgram extends string,
>(
  input: RemoveMintFromGroupAsyncInput<
    TAccountPayer,
    TAccountAuthority,
    TAccountGroup,
    TAccountMember,
...
> {
  ...
  if (!accounts.member.value) {
    accounts.member.value = await getProgramDerivedAddress({
      programAddress,
      seeds: [
